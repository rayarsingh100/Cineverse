...
export default async function SignupPage() {
    ...
    const movie =
        data.results.find(
            (item: { backdrop_path?: string | null }) => item.backdrop_path,
        ) || data.results[0];
                    ...
                    <div className="hidden lg:block">
                        <div className="max-w-2xl">
                            ...
                            <p className="mt-8 max-w-xl text-lg leading-8 text-zinc-300">
                                Create your CineVerse account and unlock a
                                smarter way to discover movies, choose your
                                seats and book your perfect cinema experience.
                            </p>
